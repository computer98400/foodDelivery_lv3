...
pluralCaseList.push( {plural: "orderTables", pascal: "OrderTable"} )

pluralCaseList.push( {plural: "storeTables", pascal: "StoreTable"} )

pluralCaseList.push( {plural: "riderTables", pascal: "RiderTable"} )
